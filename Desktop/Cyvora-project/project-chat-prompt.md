...
Project direction:
- This is AI Command Center, an autonomous business operating system.
- The interface should feel like a founder operating a futuristic holding company from one command center.
- The user gives business objectives, not individual agents.
