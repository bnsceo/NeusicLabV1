        ...
        <section className="cyvora-glass-strong rounded-2xl p-5 md:p-7">
          <div className="flex flex-wrap items-start justify-between gap-5">
            <div className="flex gap-4">
              <div className="h-14 w-14 rounded-2xl border border-white/10 shadow-[inset_1px_1px_0_rgba(255,255,255,0.05),8px_8px_16px_rgba(0,0,0,0.28)]" style={{ backgroundColor: company.brand_color || '#38bdf8' }} />
              <div>
            ...
            <div className="space-y-3">
              {company.tasks?.length ? (
                company.tasks.map((task: any) => (
                  <div key={task.id} className="cyvora-tactile rounded-xl p-4">
              ...
              <div className="mt-4 space-y-3">
                {company.outputs?.length ? (
                  company.outputs.slice(0, 5).map((output: any) => (
                    <div key={output.id} className="cyvora-tactile rounded-xl p-4">
