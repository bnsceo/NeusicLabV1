...
MainComponent::MainComponent()
{
    ...
    brandLabel.setText("NEUSIC STUDIO", juce::dontSendNotification);
    ...
    prepareButton(rewindButton);
    prepareButton(playButton);
    prepareButton(recordButton);
    prepareButton(arrangeTab);
    prepareButton(recordTab);
    prepareButton(soundsTab);
    prepareButton(mixerTab);
    prepareButton(exportTab);
    ...
    {
        audioEngine.setMonitoringEnabled(monitorButton.getToggleState());
    };
